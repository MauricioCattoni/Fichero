    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>infoVeg</b></span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <?php if(isset($_SESSION["user_id"])):?>
              ...
              <li><a href="../"><i class='fa fa-dashboard'></i> <span>V&V ADMIN</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./?view=categories"><i class="fa fa-circle-o"></i> Etiquetas</a></li>
          </ul>
        </li>
...
<div class="login-box">
      ...
      <center><h4>PANEL STAFF</h4></center>
